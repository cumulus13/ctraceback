...
def install():  # sourcery skip: remove-redundant-fstring
    ...
    console.print(f"[#00FFFF on #FF00AA]Do you want to install[/] [bold #FFFF00](run 'pip install .')[/] [warning]?[/] [critical]\[y/n]:[/] ", end = '')
    q = input()
    if q == 'y':
